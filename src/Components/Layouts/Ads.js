    ...
    <div className="font-Baloo block mb-12 Ads">
      <div className="w-90 mx-5  mt-16">
        ...
        <div className="flex items-center justify-between mt-12 md:w-1/3 md:ml-12 mx-5">
          <button
            className=" bg-reCycle-green w-32 text-white border border-white rounded-xl  md:my-8"
            onClick={() => {
              setIsOffers(true)
            }}
          >
          ...
          <button
            className="text-reCycle-green w-32 bg-white border border-reCycle-green rounded-xl "
            onClick={() => {
              setIsOffers(false)
            }}
          >
